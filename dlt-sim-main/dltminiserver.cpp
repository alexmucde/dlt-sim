...
void DLTMiniServer::sendValue(QString appId,QString ctxId, QString text,int logLevel)
{
    ...
    data += 0x25; // htyp: Use extended header, with ECU Id ,version 0x1
    data += (char)0x00; // message counter
    data += (char)0x00; // length high byte
    data += (char)4+4+10+4+2+text.length(); // length low byte
    data += ecuId[0].toLatin1(); // ECUID
    data += ecuId[1].toLatin1(); // ECUID
    data += ecuId[2].toLatin1(); // ECUID
    data += ecuId[3].toLatin1(); // ECUID
...
void DLTMiniServer::sendValue2(QString appId,QString ctxId, QString text1,QString text2,int logLevel)
{
    ...
    data += (char)0x00; // message counter
    data += (char)0x00; // length high byte
    data += (char)4+4+10+4+2+text1.length()+4+2+text2.length(); // length low byte
    data += ecuId[0].toLatin1(); // ECUID
    data += ecuId[1].toLatin1(); // ECUID
    data += ecuId[2].toLatin1(); // ECUID
    data += ecuId[3].toLatin1(); // ECUID
...
void DLTMiniServer::sendValue3(QString appId,QString ctxId, QString text1,QString text2,QString text3,int logLevel)
{
    ...
    data += (char)0x00; // message counter
    data += (char)0x00; // length high byte
    data += (char)4+4+10+4+2+text1.length()+4+2+text2.length()+4+2+text3.length(); // length low byte
    data += ecuId[0].toLatin1(); // ECUID
    data += ecuId[1].toLatin1(); // ECUID
    data += ecuId[2].toLatin1(); // ECUID
    data += ecuId[3].toLatin1(); // ECUID
